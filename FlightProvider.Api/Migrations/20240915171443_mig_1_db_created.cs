...
namespace FlightProvider.Api.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FlightDetailFlightId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FlightNo = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightDetail", x => x.FlightId);
                    table.ForeignKey(
                        name: "FK_FlightDetail_Flight_FlightId",
                        column: x => x.FlightId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_FlightDetailFlightId",
                table: "AspNetUsers",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_FlightDetail_FlightDetailFlightId",
                table: "AspNetUsers",
                column: "FlightDetailFlightId",
